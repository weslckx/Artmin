...
<html>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="col-8">
                <h4 class="text-center my-auto text-white">SELECT NOTE</h4>
            </div>

            <div class="col col-1" onclick="location.href = '<c:url value='/notes/new-${event.id}'/>';" style="cursor: pointer;">
                ...
                <div class="col">
                    ...
                    <div class="modal-content shadow">
                        ...
                        <div class="modal-footer">
                            <button onclick="location.href = '<c:url value='/notes/edit-${note.id}-${event.id}'/>';"  type="button" class="btn btn-warning">
                                <i class="material-icons small">edit</i>
                            </button> 

                            <button onclick="window.location.href = '<c:url value='/notes/delete-${note.id}-${event.id}'/>';" type="button" class="btn btn-danger">
